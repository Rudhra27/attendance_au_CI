 ...
 * com.CI.attendance.Model.User;
 * 
 * @SpringBootTest
 * 
 * @AutoConfigureMockMvc public class UserApiTests {
 * 
 * @Autowired private MockMvc mockMvc;
 * 
 * @Autowired private ObjectMapper objectMapper;
 * 
 * @Test public void shouldCreateUser() throws JsonProcessingException,
 * Exception { String email = "dave.Kumar@gmail.com"; String password =
 * "dave2022"; User newUser = new User(email, password, password, password,
 * password, password);
 * 
 ...
 * 
 * resultActions.andExpect(status().isCreated()); resultActions.andDo(print());
